...
const ProductsC = ({match,history}) => {
    ...
    return (
        ...
        <div className = 'Cgfilter'>
            <h1>{Cg ? Cg : keyword ?  "*" + keyword + "* Search" : 'Products'}</h1>
            ...
            <ul>
                    ...
                    <Link className = 'lined'  to = '?cg=Summer'>Summer</Link>
                    <Link className = 'lined'  to = '?cg=Winter'>Winter</Link>
                    <Link className = 'lined'  to = '?cg=Spring'>Spring</Link>
            </ul>
            </div>
        </div>
